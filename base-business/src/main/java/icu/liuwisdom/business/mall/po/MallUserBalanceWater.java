...
@Getter
@Setter
@TableName("mall_user_balance_water")
@ApiModel(value = "MallUserBalanceWater对象", description = "商城 用户余额流水信息")
public class MallUserBalanceWater extends BaseModel implements Serializable {
